...
After that, the frontend can be accessed from http://localhost:3000
...
Running the app this way enables hot reload which is very handy for developing.

First, run `npm i`.

Run the app using `npm start`.

## Some autogenerated text about create-react-app
